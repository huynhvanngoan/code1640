    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                // const [academicYearAll] = await Promise.all([
                ...
                setTotalAcademicYearsAll(academicData); 

                // const academicYear = academicYearAll.data.map((item) => ({
                //     name: item.name,
                //     count: item.count,
                // }));
                // setTotalAcademicYearsAll(academicYear);
