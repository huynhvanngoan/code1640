...
const StyledContent = styled(Content)`
  margin-left: ${props => props.collapsed ? '80px' : '230px'};
  width: ${props => `calc(100% - ${props.collapsed ? '80px' : '230px'})`};
  margin-top: 55px;

  @media (max-width: 767px) {
    margin-left: ${props => props.collapsed ? '60px' : '100%'};
    width: ${props => `calc(100% - ${props.collapsed ? '60px' : '100%'})`};
  }
`;
