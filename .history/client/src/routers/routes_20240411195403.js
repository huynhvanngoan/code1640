...
const StyledContent = styled(Content)`
    ...
    width: ${(props) => `calc(100% - ${!props.collapsed ? "60px" : "200px"})`};
}

@media (max-width: 768px) {
    margin-left: ${(props) => (!props.collapsed ? "50px" : "100%")};
    width: ${(props) => `calc(100% - ${props.collapsed ? "50px" : "100%"})`};
}

@media (max-width: 480px) {
    margin-left: ${(props) => (props.collapsed ? "40px" : "100%")};
    width: ${(props) => `calc(100% - ${props.collapsed ? "40px" : "100%"})`};
}
    }
`;
